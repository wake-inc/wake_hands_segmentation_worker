custom_imports = dict(imports=["care_ego.registry"], allow_failed_imports=False)
...
model = dict(
    ...
    pretrained=None,  # final checkpoints already contain backbone weights
    ...
    decode_head1=dict(
        ...
        mlp_ratio=4,
        align_corners=False,
        loss_decode=[dict(type="FocalLoss", use_sigmoid=True, loss_weight=0.5)],
    ),
    decode_head2=dict(
        type="CaregoDecoder2",
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            seg_map_path_hand="train/label_hand",
            seg_map_path_left_obj="train/lbl_obj_left",
            seg_map_path_right_obj="train/lbl_obj_right",
            seg_map_path_two_obj="train/lbl_obj_two",
            seg_map_path_cb="train/label_contact_first",
        ),
        pipeline=[
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(  # change this path to various in-domain and out-of-domain test sets
            img_path="minihoi4d/image",
            seg_map_path="minihoi4d/label",
            seg_map_path_hand="minihoi4d/label_hand",
            seg_map_path_left_obj="minihoi4d/lbl_obj_left",
            seg_map_path_right_obj="minihoi4d/lbl_obj_right",
            seg_map_path_two_obj="minihoi4d/lbl_obj_two",
            seg_map_path_cb="minihoi4d/label_contact_first",
        ),
        pipeline=[
            dict(type="LoadMultiLabelImageFromFile"),
            dict(type="LoadSeperateTwoObjAnnotation"),
